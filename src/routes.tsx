...
const getRoutes = () => {
  ...
  if (PUBLIC_PROJECTS_ACCESS) {
    return (
      <Switch>
        ...
        {
          !isDisabled('T10') &&
          <Route exact={true} path="/tools/T10/:id/:property?/:pid?" component={Scenes.T10}/>
        }
        ...
        <Route exact={true} path="/tools/T15/:id?" component={Scenes.T15}/>
  ...
  return (
    <Switch>
      ...
      <PrivateRoute exact={true} path="/tools/T15/:id?" component={Scenes.T15} forRoles={['ROLE_USER']}/>
      ...
      <PrivateRoute exact={true} path="/tools/T20/" component={Scenes.T20.CreateRealTimeModelling}
                    forRoles={['ROLE_USER']}/>
      <PrivateRoute exact={true} path="/tools/T20/:id/:property?/:pid?" component={Scenes.T20.EditRealTimeModelling}
                    forRoles={['ROLE_USER']}/>
      <PrivateRoute path="/credentials" component={Scenes.UserCredentials} forRoles={['ROLE_USER']}/>
      <PrivateRoute path="/profile" component={Scenes.UserProfile} forRoles={['ROLE_USER']}/>
