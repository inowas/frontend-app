            ...
            <div className="app-width container">
                <div className="row top-space">
                    ...
                    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                        INOWAS
                        if you do not agree to take all of the terms and conditions stated on this page. Our Terms and
                    ...
                    <p>Unless otherwise stated, Research Group INOWAS from TU-Dresden and/or its licensors own the
                        intellectual
                        property rights for all material on INOWAS. All intellectual property rights are reserved. You
                        may
                        access this from INOWAS for your own personal use subjected to restrictions set in these terms
                        and
                        conditions.</p>

                    <p>You must not:</p>
                    <ul>
                        <li>Republish material from INOWAS</li>
                        <li>Sell, rent or sub-license material from INOWAS</li>
                        <li>Reproduce, duplicate or copy material from INOWAS</li>
                        <li>Redistribute content from INOWAS</li>
                    </ul>
                    ...
                    <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                        information in
                        certain areas of the website. Research Group INOWAS from TU-Dresden does not filter, edit,
                        publish or
                        review Comments prior to their presence on the website. Comments do not reflect the views and
                        opinions
                        of Research Group INOWAS from TU-Dresden,its agents and/or affiliates. Comments reflect the
                        views and
                        opinions of the person who post their views and opinions. To the extent permitted by applicable
                        laws,
                        Research Group INOWAS from TU-Dresden shall not be liable for the Comments or for any liability,
                        damages
                    ...
                    <p>Research Group INOWAS from TU-Dresden reserves the right to monitor all Comments and to remove
                        any
                    ...
                    <p>You hereby grant Research Group INOWAS from TU-Dresden a non-exclusive license to use, reproduce,
                        edit
                    ...
                    <p>We will approve link requests from these organizations if we decide that: (a) the link would not
                        ...
                        the
                        absence of Research Group INOWAS from TU-Dresden; and (d) the link is in the context of general
                        resource
                        information.</p>
                    ...
                    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to
                        our
                        website, you must inform us by sending an e-mail to Research Group INOWAS from TU-Dresden.
                        Please
