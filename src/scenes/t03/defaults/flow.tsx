...
export const documentation = {
  ...
  // LAK
  lak: {
    nlakes: <div>Number of separate lakes. Sublakes of multiple-lake systems are considered separate lakes for input
      purposes. The variable NLAKES is used, with certain internal assumptions and approximations, to dimension arrays
