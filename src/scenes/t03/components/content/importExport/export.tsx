import {BoundaryCollection, ModflowModel, Soilmodel, Transport, VariableDensity} from '../../../../../core/model/modflow';
...
const ExportUI = () => {
  ...
  const getExportDataStructure = () => {
    ...
    return {
      ...
      transport: T03.transport ? Transport.fromObject(T03.transport).toObject() : undefined,
      variableDensity: T03.variableDensity ? VariableDensity.fromObject(T03.variableDensity).toObject() : undefined,
      packages: T03.packages && T03.packages.data ? FlopyPackages.fromObject(T03.packages.data).toObject() : undefined
    };
  };
