...
class BcfPackageProperties extends AbstractPackageProperties {
    ...
    render() {
        ...
        return (
            <Form>
                <Header as={'h4'} dividing>Block Centered Flow Package</Header>
                ...
                <Form.Group>
                    <Form.Field width={7}>
                        ...
                        <Form.Dropdown
                            options={[
                                {key: 0, value: 'intercellt0', text: 'harmonic mean'},
                                {key: 1, value: 'intercellt1', text: 'arithmetic mean'},
                                {key: 2, value: 'intercellt2', text: 'logarithmetic mean'},
                                {key: 3, value: 'intercellt3', text: 'combination'},
                            ]}
                            selection
                            name='intercellt'
