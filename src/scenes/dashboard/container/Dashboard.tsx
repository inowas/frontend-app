import { Button, Container, Dimmer, Grid, Header, Icon, Loader } from 'semantic-ui-react';
...
const Dashboard = (props: IProps) => {
  ...
  const handleToolClick = (slug: string) => {
    if (slug === 'T01' || slug === 'T04' || slug === 'T06' || slug === 'T11' || slug === 'T100') {
  ...
  const handleCloneInstance = (tool: string, id: string) => {
    ...
    setIsLoading(true);
    return sendCommand(
      cloneToolInstance(tool, id, newId),
      () => {
                ...
                <Grid.Row columns={3}>
                  ...
                  <Grid.Column width={4} align="right">
                    <Button.Group size="tiny">
                      ...
                      <Button.Or />
                      <Button onClick={() => setToPublic(true)} primary={showPublicInstances}>
                        Public
                      </Button>
                    </Button.Group>
                  </Grid.Column>
