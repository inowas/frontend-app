...
const ResourceManager = (props: IProps) => {
  return (
    <Modal closeIcon open={true} onClose={props.onClose} size="fullscreen">
      <Header>
        <Icon name="table" />
        ...
        <Grid>
          <Grid.Row stretched>
            <Grid.Column width={4}>
              ...
              <Form>
                <Form.Field control={Checkbox} label={<label>Hydrotechnical structures</label>} />
                <Form.Field control={Checkbox} label={<label>Natural water bodies</label>} />
              </Form>
            </Grid.Column>
                      ...
                      <Grid>
                        <Grid.Row>
                          <Grid.Column width={4}>
                            ...
                            <div>
                              <Label size="small" image className="object-reward">
                                <Image size="mini" src={marCoin} />
                                -20
                              </Label>
                              <Label size="small" image className="object-reward">
                                <Image size="mini" src={happyPoints} />
                                +14
                              </Label>
                            </div>
                          </Grid.Column>
                          <Grid.Column width={3}>
                            <Form>
                              <Form.Field inline control={Input} label="Lat" placeholder="34,7356" width={16} />
                              <Select placeholder="fixed" options={variabilityOptions} style={{ minWidth: '8em' }} />
                            </Form>
                          </Grid.Column>
                          <Grid.Column width={3}>
                            <Form>
                              <Form.Field inline control={Input} label="Long" placeholder="34,7356" width={16} />
                              <Select placeholder="fixed" options={variabilityOptions} style={{ minWidth: '8em' }} />
                            </Form>
                          </Grid.Column>
                          <Grid.Column width={6}>
                            <Form>
                              <Form.Group>
                                <Form.Select
                                  ...
                                  width={12}
                                />
                                <Form.Field control={Input} label="&nbsp;" placeholder="Limit" width={4} />
                              </Form.Group>
                            </Form>
                          </Grid.Column>
                        </Grid.Row>
                      ...
                      <Grid>
                        <Grid.Row>
                          <Grid.Column width={4}>
                            ...
                            <Card>
                              <Card.Content>
                                <Image floated="left" size="mini" src={infiltrationPond} />
                          ...
                          <Grid.Column width={5}>
                            <Form>
                              <Header size="tiny" style={{ fontWeight: 'bold' }}>
                                Location
                              </Header>
                              <Form.Field inline>
                                <label>Lat</label>
                              ...
                              <Form.Field inline control={Input} label="Long" placeholder="34,7356" />
                            </Form>
                          </Grid.Column>
                          <Grid.Column width={6}>
                            <Form>
                              ...
                              <Form.Group>
                                <Form.Select fluid options={options} placeholder="Please select" width={12} />
                                <Form.Field control={Input} placeholder="Limit" width={4} />
                              </Form.Group>
                            </Form>
                          </Grid.Column>
                        </Grid.Row>
        ...
        <Table>
          ...
          <Table.Body>
            <Table.Row>
              ...
              <Table.Cell>
                <Select placeholder="" options={variabilityOptions} style={{ minWidth: '8em' }} />
              </Table.Cell>
