        ...
        {this.state.showInfo && (
          <Message onDismiss={this.handleDismiss}>
            ...
            <p>
              ...
              on a criterion. When there are selected relations, you can delete them or change their effect value with
              the buttons on the right. Do not forget to save changes by clicking on the blue button on the left.
            </p>
            <p>
              There is one more node, than criteria, which describes the whole suitability project itself. You can
              connect criteria with this node, to give information about their influence on the whole project.
            </p>
          </Message>
        )}
        {weights.length > 0 && (
