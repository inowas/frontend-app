import {Button, Dropdown, Grid, Header, Icon, Label, Loader, Message, Popup, Segment, Table} from 'semantic-ui-react';
...
const DataSources = (props: IProps) => {
    ...
    const renderDataSourcesTable = () => {
        if (!dataSources || isFetching) {
            return <Loader active={true} inline="centered"/>;
        }

        const dataSourceCollection = DataSourceCollection.fromObject(dataSources);
        ...
        <Grid>
            <Grid.Row>
                <Grid.Column>
                    ...
                    {!isFetching && dataSources && dataSources.length > 0 &&
                    <Segment color={'grey'} raised={true}>
                        <Label color={'blue'} ribbon={true} size={'large'}>
                            Chart
                        </Label>
                        <DataSourcesChart
                            dataSources={DataSourceCollection.fromObject(dataSources)}
