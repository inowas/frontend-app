...
import {defaultsWithSession} from '../defaults/T14A';
        ...
        return (
            <AppContainer navbarItems={navigation}>
                ...
                <ToolGrid rows={2}>
                    <Background
                        image={image}
                        title='T14A. River drawdown // Fully penetrating stream with no streambed resistance'
                    />
...
export default withSession(withRouter(T14A));
