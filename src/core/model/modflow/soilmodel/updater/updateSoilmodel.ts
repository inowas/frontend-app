...
import {update1v0to2v1, update2v0to2v1} from './index';

/**
 * Checks incoming soilmodel and updates to newest version if necessary. The function can be used alone, outside of the
 * ./updater.ts
 *
